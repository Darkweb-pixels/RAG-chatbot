...
def store_document_embeddings(
    ...
    def chunk_text(text, chunk_size=250, overlap=50):
        """
        Split text into smaller, more focused chunks for precise point-to-point retrieval
        ...
        """
        # First split by paragraphs to try to keep related content together
        ...
        for paragraph in paragraphs:
            ...
            # If paragraph is very short, add it directly
            if len(paragraph.split()) <= chunk_size:
                chunks.append(paragraph)
                continue
                
            # Split larger paragraphs by sentences then by words
